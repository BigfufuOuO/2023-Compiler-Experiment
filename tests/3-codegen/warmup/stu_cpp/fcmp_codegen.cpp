...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("bcnez $fcc0, true_fcmp");
    codegen->append_inst("b false_fcmp");
    codegen->append_inst("");

    codegen->append_inst("true_fcmp", ASMInstruction::Label);
    codegen->append_inst("addi.w $t0, $zero, 1");
    codegen->append_inst("st.w", {"$t0", "$fp", std::to_string(offset_map["%op0"])});
    codegen->append_inst("b exit_fcmp");
    codegen->append_inst("");

    codegen->append_inst("false_fcmp", ASMInstruction::Label);
    codegen->append_inst("addi.w $t0, $zero, 0");
    codegen->append_inst("st.w", {"$t0", "$fp", std::to_string(offset_map["%op0"])});
    codegen->append_inst("b exit_fcmp");
    codegen->append_inst("");

    codegen->append_inst("exit_fcmp", ASMInstruction::Label);
    ...
    codegen->append_inst("xor $t0, $t1, $t2");
    ...
    codegen->append_inst("beq $t0, $zero, .main_label4");
