...
void translate_main(CodeGen *codegen) {
    ...
    // 间中
    offset_map["%op1"] = -(16+4+4); // TODO: 请填空
    ...
    codegen->append_inst("and $t1, $t0, $t2");
    ...
    offset_map["%op2"] = -(16+4+4+4); // TODO: 请填空
    ...
    codegen->append_inst("slt $t1, $t0, $zero"); //t1 = (t0 < 0)
    codegen->append_inst("slt $t2, $zero, $t0"); //t2 = (t0 > 0)
